...
import { getDesacProperties } from '../../../api/propertiesApi';

import PropertiesList from "../PropertyListActive/properties-list";
...
const PropertyListDesact  = () => {
    ...
    const { data: properties } = useQuery('desactProperties',getDesacProperties);
