...
import { Amenidades, Amueblado,categories, AptoMascotas, AptoNinos, CuotaMantenimiento, DetallesExternos, DetallesInternos, PatioJardin, TipoInmueble, Electrica, UbicacionCatastral, UbicacionDemografica, UbicacionGeografica, Estado, DetallesExternosMulti, CategoriaInmueble } from '../../../BD/bd';
import Select from 'react-select';
import { updateCategory } from '../../../api/usersApi';
...
const InsertProperty = () => {
  ...
  const { mutate: updateMutation, isLoading: isLoadingInsert, isError, errors} = useMutation(updateCategory);
    ...
    try {
      ...
      categoriesToUpdate.map((cat)=>{
        ...
        updateMutation(value, {
          onSuccess: () => {
            message.success('El inmueble se actualizó exitosamente');
          },
          onError: (error) => {
  ...
  <div className='flex flex-col h-screen'>
    <div className="inset-y-0 mb-20 left-0 flex h-screen justify-center align-middle items-center pl-3">            
    ...
    <div className="flex flex-wrap justify-center m-3">
      ...
      <option value="" label="">
        ...
        <Field type="number" name='cuotaMatenimiento' placeholder="Cuota mantenimiento" className="input-admin-property m-2 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 p-2" />
        <div className="space mb-2.5">
              {errors.cuotaMatenimiento && touched.cuotaMatenimiento ? <div className="errordiv text-xs">{errors.cuotaMatenimiento}</div> : null}
        </div>
        <div className="space mb-2.5">
      ...
      <Field type="text" placeholder="Anunciante" name="anunciante" className="input-admin-property m-2 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 p-2" />
        ...
        <Field type="text" placeholder="Servicios" name="servicios" className="input-admin-property m-2 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 p-2" />
        <div className="space mb-2.5">
              {errors.servicios && touched.servicios ? <div className="errordiv text-xs">{errors.servicios}</div> : null}
        </div>
      ...
      <Select className='categories' name='categorias'
        options={ categories }
    ...
    <div className="inset-y-0 mt-3 left-0 flex justify-center align-middle items-center pl-3">            
        <div className="">
            <button type="submit" className="mr-2 mb-3 py-2 px-4 rounded bg-blue-700 text-white">Guardar los datos del inmueble</button>
        </div>     
    </div>
    </Form>
        )}
