...
const EditProperty = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-fit">
      <MetaData title="Editar propiedad" description="Editar propiedad" />
      <div
        className={
      ...
      {id ? (
        <div
          className={
            location?.pathname.includes("/admin/properties/edit-property")
        ...
        <div className="">
                ...
                {property?.amenidades
                  ? Amenidades.map((chexboxOld) => (
                      ...
                      >
                        ...
                        <span>
                          {IsInArray(chexboxOld, property.amenidades)}
                        </span>
                      </label>
                    ))
                ...
                {property?.jardinPatio
                  ? PatioJardin.map((chexboxOld) => (
                      ...
                      >
                        ...
                        <span>{chexboxOld.label}</span>
                        <span>
                          {IsInArray(chexboxOld, property?.jardinPatio)}
                        </span>
                      </label>
                    ))
                  : PatioJardin.map((checkbox) => (
                      ...
                      >
                        <input
                          ...
                          checked={checkbox.checked}
                          onChange={() =>
                            handleCheckboxChangePatio(checkbox.value)
                          }
                        />
                        <hr />
                        <span>{checkbox.label}</span>
          ...
          <div className="flex justify-center w-full mb-2">
            <textarea
              ...
              className="input-admin-property mx-12 max-[450px]:w-[323px] lg:mx-80 max-[450px]:mx-2 h-72 w-full m-2 p-2"
            />
          </div>
