...
export const QueriesByFilters = (filterValue) => {
  ...
  const queries = [
    ...
    { name: `&filters[precio][$lte]=${precio}`, value: precio },
    ...
    { name: `&filters[areaTerreno][$lte]=${areaTerreno}`, value: areaTerreno },
    { name: `&filters[areaPropiedad][$lte]=${areaPropiedad}`, value: areaPropiedad },
    ...
    { name: `&filters[areaPlantas][$lte]=${areaPlantas}`, value: areaPlantas },
    ...
    { name: `&filters[areaMesanini][$lte]=${areaMesanini}`, value: areaMesanini },
    { name: `&filters[areaSotano][$lte]=${areaSotano}`, value: areaSotano },
    { name: `&filters[cuotaMantenimiento][$lte]=${cuotaMantenimiento}`, value: cuotaMantenimiento },
    { name: `&filters[areaBodega][$lte]=${areaBodega}`, value: areaBodega },
    { name: `&filters[altura][$eq]=${altura}`, value: altura },
    { name: `&filters[areaContruccion][$lte]=${areaContruccion}`, value: areaContruccion },
    ...
    { name: `&filters[precioAlquiler][$lte]=${precioAlquiler}`, value: precioAlquiler },
    { name: `&filters[precioAlquilerCompra][$lte]=${precioAlquilerCompra}`, value: precioAlquilerCompra },
