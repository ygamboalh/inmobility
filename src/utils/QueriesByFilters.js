...
const {
  ...
  const queries = [
    ...
    { name: `&filters[precio][$lt]=${precio}`, value: precio },
    ...
    { name: `&filters[areaTerreno][$lt]=${areaTerreno}`, value: areaTerreno },
    { name: `&filters[areaPropiedad][$lt]=${areaPropiedad}`, value: areaPropiedad },
