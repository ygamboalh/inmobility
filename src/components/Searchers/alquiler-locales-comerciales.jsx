  ...
  const { handleChange, handleSubmit, values, errors, touched } = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (urlFinal.length !== 0) {
        ...
        const url = `${API}properties?filters[categories][id][$eq]=6${urlQuery}`;
          ...
          .then((response) => {
            ...
            if (propertyList.length !== 0) {
              navigate("/home/search/search-results", {
                state: {
                  propertyList,
                  categories: "Alquiler de Locales Comerciales",
                },
              });
            } else {
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div className="flex mt-3 justify-center align-middle items-center w-full">
          <div className="font-semibold max-[450px]:text-xs text-xl text-center flex flex-col">
            ...
            <span>Alquiler de locales comerciales</span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center m-3">
          ...
          <div className="flex flex-row w-fit border max-[500px]:mb-2 rounded-lg pl-1 border-gray-300 input-admin-property ml-1 mr-1 py-2">
            <select
              id="dropdown-button"
              name="monedaAlquiler"
              onChange={handleChange}
          ...
          <input
            ...
            className="input-admin-property text-gray-500 m-2 w-80 w-[323px] p-2"
          />
          <div className="space -mt-4">
