          ...
          .then((response) => {
            ...
            if (propertyList.length !== 0) {
              navigate("/home/search/search-results", {
                state: {
                  propertyList,
                  categories: "Venta de Fincas, Lotes, Predios o Terrenos",
                },
              });
            } else {
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div className="flex mt-3 justify-center align-middle items-center w-full">
          <div className="font-semibold max-[450px]:text-xs text-xl text-center flex flex-col">
            ...
            <span>Venta de Fincas, Lotes, Predios o Terrenos</span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center m-3">
          ...
          <div className="flex flex-row w-fit input-admin-property mx-2 py-2">
            <select
              id="dropdown-button"
              name="moneda"
              onChange={handleChange}
          ...
          <div className="flex flex-row w-fit input-admin-property py-2">
            <select
            ...
            <div className="relative w-full">
              <input
                ...
                className="block text-gray-500 max-[650px]:w-[240px] p-2.5 w-[183px] bg-transparent z-20 text-sm rounded-r-md border-l-transparent border focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
          <select
