      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row' >
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-b-gray-300 rounded-lg px-6 py-8' >
          ...
          <form className='flex flex-col gap-y-4' onClick={(e) => {
            ...
            />
            <textarea
              className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message*'
              defaultValue='Hello, I am interested in [Modern apartment]'
            ></textarea>
            <div className='flex gap-x-2' >
              <button className='bg-violet-700 hover:bg-violet-800 rounded p-4 text-white text-sm w-full transition' >Send message</button>
